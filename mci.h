...
extern DSTATUS MCI_initialize (void);
extern DSTATUS MCI_status (void);
extern DRESULT MCI_read (BYTE*, DWORD, UINT);
extern DRESULT MCI_write (const BYTE*, DWORD, UINT);
extern DRESULT MCI_ioctl (BYTE, void*);
